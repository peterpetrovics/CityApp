...
public class City extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] arraySpinner = new String[] {
                "Debrecen", "Budapest", "Pécs", "Miskolc", "Sopron"
        };
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "";
                if (spinnertext.equals("Budapest")) {
                        ...
                        new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    //A Json objektum feldolgozása után elindíthatjuk a térképet, melyhez a showmap metódust hívjuk meg
                                    showMap(cityName, latitude, longitude);
    ...
    private void showMap(String cityName, double latitude, double longitude) {
